...
num_markers = 4
boxSize = 120
marker_ranges = {0: [(80, 101, 0), (91, 255, 255)], 1: [(92,52,0), (119,255,167)], 2: [(165, 113, 77), (179, 255, 255)], 3: [(0, 157, 90), (8, 255, 255)]}
markers = {0: "CYAN", 1: "BLUE", 2: "PINK", 3: "ORANGE"}
marker_pos = {0: (0,0), 1:(boxSize, 0), 2: (0, boxSize), 3: (boxSize, boxSize)}
...
def look_for_marker(image, marker_num):
	...
	if len(cnts) > 0:
		c = max(cnts, key=cv2.contourArea)
		x, y, w, h = cn2.boundingRectangle(c)
